    ...
    <>
      ...
      <MaxWidthWrapper className="pt-10 ">
        <MaxWidthWrapper className="px-0 sm:px-0 md:px-0 ">
          <div className="lg:grid lg:grid-cols-12 lg:gap-8 place-items-center space-y-6">
            <div className="flex flex-col space-y-6 sm:space-y-10 lg:items-center text-center lg:text-left max-w-2xl md:max-w-3xl mx-auto">
              ...
              <Motion direction="left">
                <p className=" flex text-gray-700  tracking-tight md:font-normal max-w-xl mx-auto lg:max-w-none">
                  ...
                  labore enim ipsum culpa ad. Qui sint ea irure velit elit
                  eiusmod dolor. Sunt Lorem incididunt ullamco sit aute anim
                  enim sint consequat.
                </p>
              </Motion>{" "}
